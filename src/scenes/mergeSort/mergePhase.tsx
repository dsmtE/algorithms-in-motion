...
export default makeScene2D(function* (view) {
    const seed = useScene().variables.get('seed', 142);
    ...
    view.add(
        ...
        <Circle
            ref={i_circle}
            fill={Colors.cyan}
            stroke={new Color(Colors.cyan).darken(2)}
            size={20}
            lineWidth={4}
            opacity={0}
        />
        <Circle
            ref={j_circle}
            fill={Colors.yellow}
            stroke={new Color(Colors.yellow).darken(2)}
            size={20}
            lineWidth={4}
            opacity={0}
        />
        <Circle
            ref={k_circle}
            fill={Colors.pink}
            stroke={new Color(Colors.pink).darken(2)}
            size={20}
            lineWidth={4}
            opacity={0}
        />
    ...
    view.add(
        <Layout ref={graph_algo}>
            ...
            >
                <Layout width={20} />
                <Layout ref={i_number_ref} width={20} />
                <Layout width={20} />
                <Txt ref={inferior_sign_ref} text={'<'} {...textStyle} opacity={0} />
                <Layout width={20} />
                <Layout ref={j_number_ref} width={20} />
                <Layout width={20} />
            </Rect>
            ...
            <Rect {...box_style} position={j_less_i_group_ref().bottom().addY(100)}>
                <Txt text={'While'} {...textStyle} />
                <Layout width={20} />
                <Circle fill={Colors.cyan} stroke={new Color(Colors.cyan).darken(2)} size={20} lineWidth={5} />
                <Layout width={20} />
                <Txt text={'< size('} {...textStyle} />
    ...
    yield* all(
        ...
        ...[i_circle, j_circle, k_circle].map(circle => circle().opacity(1, 0.3)),
    )
